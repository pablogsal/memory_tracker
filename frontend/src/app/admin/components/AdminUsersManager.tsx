...
import { Plus, Trash2, User, Calendar, UserCheck, AlertTriangle, Shield, Crown } from "lucide-react";
...
export default function AdminUsersManager() {
  ...
  const removeUser = async (username: string) => {
    ...
    try {
      ...
      if (response.ok) {
        setUsers(prev => prev.filter(user => user.github_username !== username));
        toast({
          title: "Success",
      ...
      <CardHeader>
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>
              Manage users with administrative privileges. Admin users can access this panel and manage system configurations.
            </CardDescription>
          </div>
                  ...
                  <div className="p-3 bg-muted/50 border rounded-md">
                    <div className="flex items-start gap-2">
                      ...
                      <div className="text-sm">
                        <p className="font-medium">Administrative privileges include:</p>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewUser(prev => ({ ...prev, github_username: e.target.value }))}
                  />
                </div>
                <div>
      ...
      <CardContent>
        ...
        {users.length > 0 && (
          <div className="mt-4 text-sm text-muted-foreground">
            <p>💡 <strong>Tip:</strong> Admin users can log in with their GitHub account and access this administration panel.</p>
          </div>
        )}
      </CardContent>
    </Card>
