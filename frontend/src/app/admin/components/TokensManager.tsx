    ...
    try {
      ...
      if (navigator.clipboard && navigator.clipboard.writeText) {
        ...
        toast({
          ...
          description: "Token selected. Press Ctrl+C (or Cmd+C) to copy. Automatic copying requires HTTPS.",
          duration: 6000,
        });
      }
    } catch (error) {
      ...
      toast({
        title: "Manual Copy Required",
        description: "Please select the token and press Ctrl+C (or Cmd+C) to copy. Automatic copying requires HTTPS.",
        duration: 6000,
      });
    }
  };
                  ...
                  {!navigator.clipboard && (
                    <div className="bg-blue-50 border border-blue-200 rounded-md p-3">
                      <p className="text-xs text-blue-800">
                        <strong>Note:</strong> Automatic copying requires HTTPS. Click the token field and use Ctrl+C (or Cmd+C) to copy.
                      </p>
                    </div>
                  )}
                </div>
