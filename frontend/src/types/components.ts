...
export interface DataTableProps<T extends Record<string, any>> extends BaseComponentProps {
  data: T[];
...
export type SortChangeHandler = (field: string, direction: SortDirection) => void;
