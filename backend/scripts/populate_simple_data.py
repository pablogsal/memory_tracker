    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            for major, minor, patch in python_versions:
                version_commits = generate_commits_for_version(2, major, minor, patch)  # Only 2 commits per version
            ...
            print(f"   - {len(result_objects)} benchmark results (3 benchmarks per run)")
